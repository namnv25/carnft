...
const TableHistory = () => {
  ...
  const columns = [
    {
      title: translation('common.tableHistory.date'),
      dataIndex: 'date',
      key: 'date',
      width: 233,
    },
    {
      title: translation('common.tableHistory.event'),
      dataIndex: 'event',
      key: 'event',
      width: 210,
    },
    {
      title: translation('common.tableHistory.price'),
      dataIndex: 'price',
      key: 'price',
      width: 232,
      render: (item: number) => {
    ...
    {
      title: translation('common.tableHistory.from'),
      dataIndex: 'from',
      key: 'from',
      width: 234,
    },
    {
      title: translation('common.tableHistory.to'),
      dataIndex: 'to',
      key: 'to',
      width: 233,
    },
